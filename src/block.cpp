...
Block::Block()
    : mRow(9),
      ...
      boomtyple(Typle_1)    //成员初始化列表
{
    audioClick=new QSound("/home/uranus/Desktop/Minesweeper/resource/click.wav");
    audioBomb=new QSound("/home/uranus/Desktop/Minesweeper/resource/faile.wav");
    audioOpenzero=new QSound("/home/uranus/Desktop/Minesweeper/resource/openzero.wav");
}
